...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-44NPIO2N.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-WBHUZC3R.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-O474MI5C.js")).default(client, args, telemetry);
    default:
